...
const ko = {
  ...
  assets: {
    ...
    sourceType: "소스 유형",
    sourceUrl: "소스 URL",
    col: { id: "자산 ID", type: "유형", name: "이름", version: "버전", semanticId: "시멘틱 ID", offering: "계약", dataSource: "데이터 소스", created: "생성일" },
  ...
  identityHub: {
    ...
    notConfiguredHint: "설정 화면 외부 연동에서 Identity Hub URL 을 입력하면 여기에 표시됩니다.",
    openSettings: "설정 열기",
    monitor: "상태 모니터링",
    statusUp: "정상",
    statusWarn: "경고",
  ...
  submodels: {
    title: "시멘틱 모델",
    subtitle: "시멘틱 모델(SAMM) 로컬 저장소",
    searchPlaceholder: "URN, 이름, 설명 검색…",
    empty: "등록된 시멘틱 모델이 없습니다.",
    create: "시멘틱 모델 추가",
    edit: "시멘틱 모델 수정",
    refresh: "새로고침",
    col: {
    ...
    delete: {
      title: "시멘틱 모델 삭제",
      message: "이 시멘틱 모델을 삭제합니다. 삭제 후 복구할 수 없습니다.",
    },
    form: {
      urn: "URN (식별자)",
