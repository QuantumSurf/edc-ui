...
const ko = {
  ...
  dashboard: {
    ...
    completedInProgress: "79건 완료 / 3건 진행 중",
  ...
  assets: {
    ...
    sourceType: "소스 유형",
    sourceUrl: "소스 URL",
    col: { id: "자산 ID", type: "유형", name: "이름", version: "버전", semanticId: "시맨틱 ID", offering: "계약", dataSource: "데이터 소스", created: "생성일" },
  ...
  policies: {
    ...
    col: { id: "정책 ID", action: "액션", constraint: "제약 조건", offeringRef: "계약 참조", created: "생성일" },
    actionUse: "사용 허가",
    sectionBasic: "기본 정보",
  ...
  negotiations: {
    ...
    col: { id: "ID", state: "상태", stateCode: "상태 코드", peer: "상대방", asset: "자산", duration: "소요 시간", time: "시각", action: "작업" },
  ...
  audit: {
    ...
    resultCount: (shown: number, total: number) => `${shown}건 / 전체 ${total}건`,
    retentionNotice: "감사 로그는 90일간 보관됩니다 (NF-12).",
  },
