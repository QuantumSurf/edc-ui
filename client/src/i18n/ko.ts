...
const ko = {
  ...
  assets: {
    ...
    deleteBlockedByOffering: "오퍼링에 등록된 자산은 삭제할 수 없습니다.",
  ...
  offerings: {
    ...
    offeringId: "오퍼링 ID",
    publish: "오퍼링 게시",
    published: "오퍼링이 게시되었습니다.",
    publishFailed: "오퍼링 게시에 실패했습니다.",
    publishing: "게시 중...",
    contractCount: "계약 수",
    count: (n: number) => `${n}건`,
    ...
    idDuplicate: "이미 존재하는 오퍼링 ID입니다.",
    noAssetsTitle: "등록된 자산이 없습니다",
    noAssetsDesc: "오퍼링을 생성하려면 먼저 자산을 등록해야 합니다.",
    goToAssets: "자산 화면으로 이동",
    noPoliciesTitle: "등록된 정책이 없습니다",
    noPoliciesDesc: "오퍼링은 access/contract 정책이 필요합니다.",
    goToPolicies: "정책 화면으로 이동",
    updated: "오퍼링이 수정되었습니다.",
    updateFailed: "오퍼링 수정에 실패했습니다.",
    editWizard: "오퍼링 수정",
    duplicateWizard: "오퍼링 복제",
    idImmutable: "오퍼링 ID는 수정할 수 없습니다.",
    jsonTitle: "오퍼링 JSON (ContractDefinition)",
    downloadJson: "JSON 다운로드",
