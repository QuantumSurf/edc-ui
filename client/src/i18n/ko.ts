...
const ko = {
  ...
  assets: {
    ...
    sourceType: "소스 유형",
    sourceUrl: "소스 URL",
    col: { id: "자산 ID", type: "유형", name: "자산 이름", version: "버전", semanticId: "시맨틱 ID", offering: "계약", dataSource: "데이터 소스", created: "생성일", action: "액션" },
  ...
  policies: {
    ...
    col: { id: "정책 ID / 요약", action: "ODRL 액션", constraint: "제약 조건", offeringRef: "계약 참조", created: "생성일", rowAction: "액션" },
    actionUse: "사용 허가",
    sectionBasic: "기본 정보",
  ...
  offerings: {
    ...
    col: { id: "계약 ID", asset: "자산", access: "접근 정책", contract: "사용 정책", cnt: "계약 수", action: "액션" },
    step1: "자산 선택",
    step2: "접근 정책",
    step3: "사용 정책",
    step4: "게시",
