...
const ko = {
  ...
  offerings: {
    ...
    col: { id: "계약 ID", asset: "자산", access: "접근 정책", contract: "계약 정책", cnt: "계약 수" },
    step1: "자산 선택",
    step2: "접근 정책",
    step3: "계약 정책",
    step4: "게시",
  ...
  vault: {
    ...
    sharedClusterDesc: (ns: string) =>
      `모든 커넥터가 단일 Vault HA 클러스터를 공유하며, 이 커넥터는 namespace "${ns}"로 격리됩니다. 운영·라이선스·감사 가시성 측면에서 per-connector Vault보다 효율적입니다.`,
    listTitle: "시크릿 / 키 목록",
  ...
  settings: {
    appearance: "외관",
    theme: "테마",
    themeDesc: "UI 테마를 선택합니다",
    themeSelect: "테마 선택",
    dataObservatory: "Data Observatory",
    dataObservatoryDesc: "다크 네이비 · 시안",
    swissPrecision: "Swiss Precision",
    swissPrecisionDesc: "클린 화이트 · 인디고",
    tacticalCommand: "Tactical Command",
    tacticalCommandDesc: "딥 다크 · 그린",
    language: "언어",
