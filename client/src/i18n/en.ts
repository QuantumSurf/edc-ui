...
const en: Translations = {
  ...
  assets: {
    ...
    col: { id: "Asset ID", type: "Type", name: "Asset Name", version: "Version", semanticId: "Semantic ID", offering: "Offering", dataSource: "Data Source", created: "Created", action: "Actions" },
  ...
  policies: {
    ...
    col: { id: "Policy ID / Summary", action: "ODRL Action", constraint: "Constraints", offeringRef: "Contract Ref.", created: "Created", rowAction: "Actions" },
  ...
  offerings: {
    ...
    col: { id: "Offering ID", asset: "Asset", access: "Access Policy", contract: "Usage Policy", cnt: "Contracts", action: "Actions" },
    step1: "Select Assets",
    step2: "Access Policy",
    step3: "Usage Policy",
    step4: "Publish",
    ...
    emptyTitle: "No contract offerings yet",
