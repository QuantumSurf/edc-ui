...
const en: Translations = {
  ...
  transfers: {
    ...
    bulk: {
      ...
      starting: "Starting...",
      bucket: "Bucket",
      objectKey: "Object key (optional)",
      endpoint: "Endpoint (S3-compatible/MinIO, optional)",
      accessKey: "Access key",
      secretKey: "Secret key",
      destHint:
        "Enter an S3/MinIO destination. Leave blank to use the server defaults (S3_*). For MinIO use an endpoint like http://host:9000.",
      cancel: "Cancel",
      canceling: "Canceling...",
      overall: "Overall",
