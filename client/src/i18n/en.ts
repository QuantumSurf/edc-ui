...
const en: Translations = {
  ...
  policies: {
    ...
    sectionOffering: "Contract References",
  ...
  identityHub: {
    title: "DID",
    subtitle: "Participant trust framework (DID / Verifiable Credentials)",
    endpoint: "Endpoint",
  ...
  submodels: {
    ...
    subtitle: "Local store for SAMM semantic models",
    ...
    delete: {
      ...
      message: "Delete this semantic model permanently?",
    },
  ...
  twins: {
    title: "Registry",
    subtitle: "AAS Shell Descriptor management",
    edit: "Edit Shell",
    ...
    detail: {
      ...
      viewJson: "View JSON",
      jsonTitle: "Raw JSON",
      jsonDesc: "AAS Shell Descriptor as stored in DTR",
      copyJson: "Copy JSON",
      downloadJson: "Download JSON",
    },
    delete: {
      title: "Delete Shell Descriptor",
      message: "Delete this shell? Linked submodels will also be removed.",
    },
    badge: {
